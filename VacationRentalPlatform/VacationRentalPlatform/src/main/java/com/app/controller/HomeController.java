...
public class HomeController {
	...
	public String viewProperty(@PathVariable("propertyId") long propertyId, Model model, Principal principal, HttpSession session) {
		...
		if(principal != null) {
		    ...
		    if(optGuest.isPresent()) {
		    	...
		    	Optional<Booking> optBooking =	bookingRepository.findByPropertyAndGuest(optProperty.get(), optGuest.get());
	...
	public String userSignUpProcess(@ModelAttribute("user") Guest guest) {
